    ...
    <div className="logo">
			...
			<form onSubmit={handleSubmit} class="signup_form">
				<div class="login__field">
					<input type="text" class="register_input login__input" 
          placeholder="User name / Email" onChange={handleChange}/>
					{isValid ? (
        <p></p>
      ) : (
        <p style={{ color: "red" }}>Invalid email format</p>
      )}
          <input type="password" class="register_input login__input" 
        ...
        <div className="create_account"><h4>Already Registered ?</h4>
				<button class="button login__signup">
					<span class="button__text"><a href="/Login">Login to tracker </a></span>
				</button></div>				
			</form>
